...
fetch('/bfmaier_facebook.json')
  ...
  .then(function(data) {
    ...
    internalLinks.forEach(function(l){
      ...
      //                            l[0].z);
      let src = new THREE.Vector3(l[0].x,
                                  l[0].y, 
                                  l[0].z);
      ...
      let geometry = new THREE.TubeGeometry( curve, 5, l[1].radius, 32, false);
      let material = new THREE.MeshBasicMaterial( { color : colors[l[1].level],transparent: true, opacity:0.4 } );
